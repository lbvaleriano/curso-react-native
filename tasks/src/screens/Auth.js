...
export default class Auth extends Component {
	...
	render() {
		// Colocar true ou false para cada validação. Ao final fazer um reduce e testar se existe algum false
		const validations = []
		...
		return (
			<ImageBackground source={backgroundImage} style={styles.background}>
				...
				<View style={styles.formContainer}>
					...
					{/* Extratégia de renderização condicional - só renderiza a segunda parte se a primeira condição for verdadeira  */}
					{this.state.stageNew &&
						<AuthInput icons='user' placeholder='Nome' style={styles.input}
