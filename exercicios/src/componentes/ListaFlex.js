...
const itemEstilo = {
    ...
    alignItems: 'center', // efetua o alinhamento no eixo secundário
    flexDirection: 'row',
    justifyContent: 'space-between', // efetua o alinhamento no eixo principal
...
export default props => {
    const renderItem = ({ item }) => { // está cessando o atributo 'item' de um objeto passado
        return <Aluno {...item} />
    }
